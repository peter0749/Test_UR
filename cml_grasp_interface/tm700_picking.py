...
if __name__ == '__main__':
    ...
    state_dir = os.path.split(os.path.abspath(__file__))[0] + '/tm700_states'
    bot = PyRobotHandler(offline=_OFFLINE, octomap=_USE_OCTOMAP, bot="tm700", camera="camera_shelf_color_optical_frame")
    grasper = GraspHandler(bot, config_path, weights_path, state_dir=state_dir)
